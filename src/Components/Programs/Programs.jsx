...
const Programs = ({ item }) => {
  const { title, short_description, age, link, bg_color, image } = item;
  ...
  return (
    <div className="group/item relative overflow-hidden pl-8 py-10 rounded-xl hover:shadow-[0px_12px_34px_0px_rgba(15,_20,_61,_0.20)] transition duration-300 ease-in-out" style={card}>
      ...
      <div className="w-4/6">
        ...
        <h2 className="mt-2 mb-4 text-[#546389] text-lg font-nunito font-medium">{age} yrs</h2>
        <p className="mb-7 text-[#626472] font-nunito font-medium text-lg">{short_description}</p>
